        ...
        <div>
            ...
            {/* 
                ...
                <div className='MainMission__sub3'>
                    ...
                    <p>Connecting Designers with Style Seekers</p>
                    <hr />
                </div>

                <div className='MainMission__sub4'>
                    <h1>Key Features — </h1>
                    <p>Tailored Experiences for Designers and Customers</p>
                    <hr />
                </div>

                <div className='MainMission__sub5'>
                    <img src='/down.svg' alt='down' />
                </div>
                <div className='MainMission__sub6'>
                    <img src='/top_right.svg' alt='down' />
                </div>
                <div className='MainMission__sub7'>
                    <img src='/down.svg' alt='down' />
                </div>
